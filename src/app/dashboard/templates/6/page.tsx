...
import { Github, Linkedin, Mail, Twitter, BookOpen, GraduationCap, Award, Calendar, BookMarked, FileText, Brain, Download, Eye, ArrowLeft } from "lucide-react";
...
export default function ResumeStyleTemplate({ portfolio, isPreview = false }: TemplateProps) {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-2">
              {isPreview && (
                <button
                  onClick={() => {
                    localStorage.setItem("selectedTemplate", "resume-style");
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-purple-50 to-gray-50 dark:from-purple-900/20 dark:to-gray-900/20" />
        <motion.div
        ...
        >
          ...
          >
            <img
              src={portfolio.profileImage || "https://api.dicebear.com/7.x/avataaars/svg?seed=Sarah"}
              alt={portfolio.fullname}
              className="w-40 h-40 mx-auto rounded-full border-4 border-purple-500 shadow-lg"
            />
          </motion.div>
          <h1 className="text-5xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-gray-600">
            {portfolio.fullname}
          </h1>
      ...
      <section className="py-20">
        ...
        >
          <motion.div variants={fadeInUp} className="max-w-3xl mx-auto text-center">
            <h2 className="text-4xl font-bold mb-8 bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-gray-600">
              About Me
            </h2>
      ...
      {/* Education Section */}
      {educationSection && (
        <section className="py-20 bg-purple-50 dark:bg-purple-900/10">
          <motion.div
            variants={staggerContainer}
            initial="initial"
            whileInView="animate"
          ...
          >
            <motion.div variants={fadeInUp} className="max-w-4xl mx-auto">
              <h2 className="text-4xl font-bold mb-12 text-center bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-gray-600">
                Education
              </h2>
