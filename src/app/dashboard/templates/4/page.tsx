...
import { Github, Linkedin, Mail, Twitter, Palette, Brush, Camera, Image, Award, Calendar, Download, Eye, ArrowLeft, GraduationCap } from "lucide-react";
...
export default function CreativeArtistTemplate({ portfolio, isPreview = false }: TemplateProps) {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-2">
              {isPreview && (
                <button
                  onClick={() => {
                    localStorage.setItem("selectedTemplate", "tech-focused");
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-pink-50 to-purple-50 dark:from-pink-900/20 dark:to-purple-900/20" />
        <motion.div
        ...
        >
          ...
          >
            <img
              src={portfolio.profileImage || "https://api.dicebear.com/7.x/avataaars/svg?seed=Emma"}
              alt={portfolio.fullname}
              className="w-40 h-40 mx-auto rounded-full border-4 border-pink-500 shadow-lg"
            />
          </motion.div>
      ...
      {/* Education Section */}
      {educationSection && (
        <section className="py-20 bg-pink-50 dark:bg-pink-900/10">
          <motion.div
            variants={staggerContainer}
            initial="initial"
            whileInView="animate"
                    ...
                    >
                      <Card className="p-6 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
                        <div className="flex items-start gap-4">
                          <GraduationCap className="w-8 h-8 text-pink-500 mt-1" />
                          <div>
                  ...
                  skillsSection.content.map((skill: Skill, index: number) => (
                    ...
                    >
                      <Card className="p-6 text-center hover:shadow-lg transition-all duration-300 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
                        <Palette className="w-8 h-8 mx-auto mb-4 text-pink-500" />
