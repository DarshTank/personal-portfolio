...
import { Github, Linkedin, Mail, Twitter, Code2, Terminal, Database, Server, Cpu, Network, Shield, Download, Eye, ArrowLeft, GraduationCap, Calendar } from "lucide-react";
...
export default function TechFocusedTemplate({ portfolio, isPreview = false }: TemplateProps) {
    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          >
            <img
              src={portfolio.profileImage || "https://api.dicebear.com/7.x/avataaars/svg?seed=Alex"}
          ...
          <p className="text-2xl text-gray-300 mb-8">{portfolio.role}</p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            {portfolio.github && (
              <Button variant="outline" size="icon" className="rounded-full bg-gray-800/50" asChild>
      ...
      <section className="py-20 bg-gray-800">
        ...
        >
          <motion.div variants={fadeInUp} className="max-w-3xl mx-auto text-center">
            <h2 className="text-4xl font-bold mb-8 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-cyan-400">
              About Me
            </h2>
        ...
        <section className="py-20 bg-gray-900">
          ...
          >
            <motion.div variants={fadeInUp} className="max-w-4xl mx-auto">
              <h2 className="text-4xl font-bold mb-12 text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-cyan-400">
                Education
              </h2>
                  ...
                  <motion.div variants={fadeInUp} whileHover={{ scale: 1.02 }}>
                    <Card className="p-6 bg-gray-800/50 backdrop-blur-sm border-gray-700">
                      <div className="flex items-start gap-4">
                        <GraduationCap className="w-8 h-8 text-blue-400 mt-1" />
                        <div>
                          <h3 className="text-xl font-semibold text-gray-100">{educationSection.content.degree}</h3>
                          <p className="text-gray-300">{educationSection.content.institution}</p>
                          <div className="flex items-center gap-2 text-sm text-gray-400 mt-2">
                            <Calendar className="w-4 h-4" />
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                {isArray(skillsSection.content) ? (
                  skillsSection.content.map((skill: Skill, index: number) => (
                    ...
                    >
                      <Card className="p-6 text-center hover:shadow-lg transition-all duration-300 bg-gray-800/50 backdrop-blur-sm border-gray-700">
                  ...
                  <motion.div variants={fadeInUp} whileHover={{ scale: 1.05 }}>
                    <Card className="p-6 text-center hover:shadow-lg transition-all duration-300 bg-gray-800/50 backdrop-blur-sm border-gray-700">
                      <Code2 className="w-8 h-8 mx-auto mb-4 text-blue-400" />
                      <h3 className="text-lg font-semibold text-gray-100">{skillsSection.content.name}</h3>
                      <div className="mt-2">
                        <div className="h-2 bg-gray-700 rounded-full">
                          <div
                            className="h-full bg-blue-500 rounded-full"
                        ...
                        <span className="text-sm text-gray-400">{skillsSection.content.level}%</span>
                      </div>
                    </Card>
                  </motion.div>
                )}
                ...
                {isArray(projectsSection.content) ? (
                  projectsSection.content.map((project: Project, index: number) => (
                    <motion.div
                      ...
                      whileHover={{ scale: 1.02 }}
                    >
                      <Card className="overflow-hidden bg-gray-800/50 backdrop-blur-sm border-gray-700">
                        ...
                        <div className="p-6">
                          ...
                          {project.github && (
                            <Button variant="outline" className="rounded-full bg-gray-800/50" asChild>
                              <a
                                href={project.github}
                                target="_blank"
                  ...
                  <motion.div variants={fadeInUp} whileHover={{ scale: 1.02 }}>
                    <Card className="overflow-hidden bg-gray-800/50 backdrop-blur-sm border-gray-700">
                      ...
                      <div className="p-6">
                        <h3 className="text-2xl font-bold mb-2 text-gray-100">{projectsSection.content.title}</h3>
